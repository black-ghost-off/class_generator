...
dtypes_names = {
    ...
    #TODO: Add langueges by priority ^_^
    #TODO: Add Rust - HIGH PRIORITY
    #TODO: Add JavaScript
    #TODO: Add Java
    #TODO: Add C#
    #TODO: Add Swift
...
template_name = {
    ...
    # TODO: Sepparate Struct and Class
...
def gen_header(file_string, lang, header_file):
    ...
    data_gen = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())

    header_content = template_name["header_templates"][lang].format(data_gen=data_gen, header_file=replace_letters_with_underscore(file_name).upper(), file_name=file_name)
...
def gen_classes(file_string, lang, classes):
    ...
    for i, class_ in enumerate(classes):
        ...
        for ib, field in enumerate(class_.get('fields', [])):
...
def gen(yaml_file, header_file, lang):
    """
    Generates a header file based on the provided YAML configuration and language.
    Args:
        yaml_file (str): Path to the YAML file containing the configuration.
        header_file (str): Path to the header file to be generated.
        lang (str): Programming language for which the header file is being generated.
    Raises:
        FileNotFoundError: If the file_structure.txt file is not found.
    """
    ...
    with open(os.path.join(os.path.dirname(__file__), "file_structure.txt"), 'r') as file_structure:
        ...
        # TODO: add suport for serilization deserialization struct/class
...
# TODO: add auto tests for generator.py
# TODO: add tests for generated files with different languages
# TODO: tests inside CI/CD
# TODO: add support for proto files
